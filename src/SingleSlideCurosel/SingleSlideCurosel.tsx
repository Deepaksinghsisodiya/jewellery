      ...
      <Slider {...settings}>
        {items.map((item, index) => (
          <div className="p-1" key={index}>
            <div className="flex flex-col items-center justify-center py-6 sm:py-10 bg-gray-600 text-white gap-2 sm:gap-3 h-40 sm:h-52 w-full mx-auto rounded-md">
              <div className="flex justify-center">{item.icon}</div>
              <p className="text-xs sm:text-sm text-center max-w-full">
                {item.title}
              </p>
              <p className="text-xs sm:text-sm text-gray-300 text-center font-semibold max-w-full">
                {item.desc}
              </p>
            </div>
          </div>
